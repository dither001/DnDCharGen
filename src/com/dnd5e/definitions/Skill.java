...
public enum Skill {
	...
	private static final Skill[] ALL_SKILLS = {
			...
			PAINTING_TOOLS, POTTING_TOOLS, SMITHING_TOOLS, TINKERS_TOOLS, WEAVING_TOOLS, WOODCARVING_TOOLS,
			//
			DISGUISE_KIT, FORGERY_KIT, CHESS_SET, GAMING_DICE, PLAYING_CARDS, HERBALISM_KIT, POISONER_KIT,
			THIEVES_TOOLS,
			//
			BAGPIPES, DRUM, DULCIMER, FLUTE, LUTE, LYRE, HORN, PAN_FLUTE, SHAWM, VIOL,
			//
	...
	private static final Skill[] ALL_TOOLS = {
			//
			IMPROVISED,
			//
			UNARMED, CLUB, DAGGER, GREATCLUB, HANDAXE, JAVELIN, LIGHT_HAMMER, MACE, QUARTERSTAFF, SICKLE, SPEAR,
	 ...
	 */
	public int indexOf() {
		return Misc.indexOfEnum(this.toString(), ALL_SKILLS);
	}
	...
	public static Skill parseTools(String s) throws ParserException {
		for (Skill el : ALL_TOOLS) {
	...
	public static List<Skill> getProfessionalSkillsList() {
